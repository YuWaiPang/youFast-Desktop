            ...
            do
            {
                if (requestDict.ContainsKey(2) && (requestDict[2].nextPageID == responseDict[requestID].requestID) && requestDict[2].drillType == "set")
                {
                    ...
                    if (requestDict[2].direction == "pageHome")
                    {
                        ...
                        currentExport1.drillDown2HtmlYMtable(isResponse, requestID2SessionID, wsServerSessionID, userPreference, ramDetailgz, _drillSet, YpageDrill, YtotalPageDrill, YpageStartDrill, YpageEndDrill, requestID, clientSessionVariable, requestDict,  responseDict, outputFolder, distinctSet, distinctList2DrillDown, ramKey2Valuegz);
                    }
                    ...
                    if (requestDict[2].openReport == "Y")
                    {
                        ...
                        currentExport1.drillDown2CSVymTable(userPreference, ramDetailgz, distinctSet, distinctList2DrillDown, ramKey2Valuegz, csvWriteSeparator, outputFolder, userPreference["system"].slash + "distinct2DrillDown" + fileNo.ToString() + "_" + requestDict[requestID].importFile);
                ...
                if (requestDict.ContainsKey(2) && (requestDict[2].nextPageID == responseDict[requestID].requestID) && requestDict[2].direction == "pageHome" && requestDict[2].drillType == "null")
                {
                    ...
                    currentExport1.ramDistinct2HtmlYMtable(isResponse, requestID2SessionID, wsServerSessionID, userPreference, tableFact, remK2V, sourceFolder, db1Folder, _ramKey2Valuegz, screenControl, Ypage, YtotalPage, YpageStart, YpageEnd, requestID, clientSessionVariable, requestDict,  responseDict, distinctList, distinctRamKey2Value, outputFolder, dataSortingOrder);
                }
                ...
                {
                    if (distinctList[0].Count <= userPreference["system"].maxExportFileRow)
                    {
                        startEventTime = DateTime.Now;
                        requestDict[2].openReport = "";
                        ExportCSV currentExport1 = new ExportCSV();
                        ...
                        currentExport1.ramDistinct2CSVymTable(userPreference, distinctList, distinctRamKey2Value, csvWriteSeparator, outputFolder, userPreference["system"].slash + "distinct" + fileNo.ToString() + "_" + requestDict[requestID].importFile);
                    ...
                    else
                    {
                        ...
                        errorMessage.AppendLine("\"Calculated output to file has " + string.Format("{0:#,0}", distinctList[0].Count) + " data rows which is greater than current user setting limit of " + string.Format("{0:#,0}", userPreference["system"].maxExportFileRow) + ".\"");
            ...
            do
            {
                if (requestDict.ContainsKey(2) && (requestDict[2].nextPageID == responseDict[requestID].requestID) && requestDict[2].drillType == "set")
                {
                    ...
                    if (requestDict[2].direction == "pageHome")
                    {
                        ...
                        currentExport1.drillDown2HtmlYMtableCrosstab(isResponse, requestID2SessionID, wsServerSessionID, userPreference, ramDetailgz, _drillSet, YpageDrill, YtotalPageDrill, YpageStartDrill, YpageEndDrill, requestID, clientSessionVariable, requestDict,  responseDict, outputFolder, distinctList2DrillDown, ramKey2Valuegz);
                    }
                ...
                if (requestDict.ContainsKey(2) && (requestDict[2].nextPageID == responseDict[requestID].requestID) && requestDict[2].direction == "Left" && Xpage > 1 && requestDict[2].drillType == "null")
                {
                    ...
                    ExportHTML currentExport1 = new ExportHTML();
                    currentExport1.ramDistinct2HtmlCrosstabTable(isResponse, requestID2SessionID, wsServerSessionID, tableFact, userPreference, ramKey2Valuegz, screenControl, YXMdistinctDrillKey, Xpage, XtotalPage, Ypage, YtotalPage, XpageStart, XpageEnd, yHeaderCol, YpageStart, YpageEnd, XdistinctList, requestID, clientSessionVariable, requestDict,  responseDict, YXMdistinctList, distinctXramKey2Value, distinctYramKey2Value, outputFolder, dataSortingOrder);
                }
                ...
                if (requestDict.ContainsKey(2) && (requestDict[2].nextPageID == responseDict[requestID].requestID) && requestDict[2].openReport == "Y" && requestDict[2].drillType == "null")
                {
                    if (YXMdistinctList[0].Count <= userPreference["system"].maxExportFileRow)
                    {
                        ...
                        currentExport1.ramDistinct2CSVcrosstabTable(userPreference, XdistinctList, requestID, clientSessionVariable, requestDict,  YXMdistinctList, distinctXramKey2Value, distinctYramKey2Value, csvWriteSeparator, outputFolder, "crosstab" + fileNo.ToString() + "_" + requestDict[requestID].importFile);
                    ...
                    else
                    {
                        StringBuilder errorMessage = new StringBuilder();
                        errorMessage.AppendLine("Error Description");
                        errorMessage.AppendLine("\"Calculated output to file has " + string.Format("{0:#,0}", YXMdistinctList[0].Count) + " data rows which is greater than current user setting limit of " + string.Format("{0:#,0}", userPreference["system"].maxExportFileRow) + ".\"");
                        responseDict[requestID].errorMessage = errorMessage;
                        responseDict[requestID].sendErrorMessage = true;
                    }
                }
