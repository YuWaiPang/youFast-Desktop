...
namespace youFast
{
    public class Json
    {
        ...
        public void Json2VariableArray(string message)
        {           
        ...
        public void Json2VariableList(string message, decimal dictNo, ConcurrentDictionary<decimal, clientMachine.request> requestDict)
        {
            ...
            if (array.ContainsKey("crosstabDimensionTemp"))
                requestDict[dictNo].crosstabDimensionTemp = array["crosstabDimensionTemp"];
            else
                requestDict[dictNo].crosstabDimensionTemp = null;
